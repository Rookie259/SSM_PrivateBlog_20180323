...
<script type="text/javascript" src="resources/game/OneGame//js/phaser.min.js" ></script>
<script>
    ...
    game.States.boot = function() {
        this.preload = function() {
            ...
            game.load.image('loading', 'resources/game/OneGame/assets/preloader.gif');
        };
    ...
    game.States.preload = function() {
        this.preload = function() {
            ...
            game.load.image('background', 'resources/game/OneGame/assets/background.png');
            game.load.image('ground', 'resources/game/OneGame/assets/ground.png');
            game.load.image('title', 'resources/game/OneGame/assets/title.png');
            game.load.spritesheet('bird', 'resources/game/OneGame/assets/bird.png', 34, 24, 3);
            game.load.image('btn', 'resources/game/OneGame/assets/start-button.png');
            game.load.spritesheet('pipe', 'resources/game/OneGame/assets/pipes.png', 54, 320, 2);
            game.load.bitmapFont('flappy_font', 'resources/game/OneGame/assets/fonts/flappyfont/flappyfont.png', 'resources/game/OneGame/assets/fonts/flappyfont/flappyfont.fnt');
            game.load.audio('fly_sound', 'resources/game/OneGame/assets/flap.wav');
            game.load.audio('score_sound', 'resources/game/OneGame/assets/score.wav');
            game.load.audio('hit_pipe_sound', 'resources/game/OneGame/assets/pipe-hit.wav');
            game.load.audio('hit_ground_sound', 'resources/game/OneGame/assets/ouch.wav');
            game.load.image('ready_text', 'resources/game/OneGame/assets/get-ready.png');
            game.load.image('play_tip', 'resources/game/OneGame/assets/instructions.png');
            game.load.image('game_over', 'resources/game/OneGame/assets/gameover.png');
            game.load.image('score_board', 'resources/game/OneGame/assets/scoreboard.png');
        };
        this.create = function() {
